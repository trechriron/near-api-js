...
export class Account2FA extends AccountMultisig {
    ...
    ********************************/
    ...
    async canDisableMultisig() {
        ...
        // there are 3 actions required to disable 2FA on top of the key conversion (2 actions per key)
        // floor((100 - 3) / 2) = LAK_CONVERSION_LIMIT - 2 = 48
     ...
     * in the wallet will continue to require 2FA approval). This method should only be used to reduce the
     * number of LAKs to a number.
     *
